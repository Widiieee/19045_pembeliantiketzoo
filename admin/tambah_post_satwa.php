...
<body>
    ...
    <div class="container">
        <form action="koneksi/koneksi_post_satwa.php" method="post" enctype="multipart/form-data">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="file" class="form-control" id="foto" name="foto" accept=".png, .jpg, .jpeg, .gif" required>
            </div>
